...
docs_train = []
docs_test=[]
filepath_train = r"data/task2prev_train.csv"
filepath_test=r"data/task2prev_test.csv"
...
print('coordinate_pred_0:', coordinate_pred[0])
print('coordinate_true_0:', coordinate_true[0])
true_sentence=get_predict_content(test_data_reader, y_test)
true_sentence=turn_sentences_to_str(true_sentence)
print('true_sentence_0:', true_sentence[0])
